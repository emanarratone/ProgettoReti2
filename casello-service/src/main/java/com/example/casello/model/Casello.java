package com.example.casello.model;
...
public class Casello {
    ...
    public Casello(Integer idCasello, String sigla, Integer idAutostrada, boolean closed, Integer limite) {
    ...
    public Casello(String sigla, Integer idAutostrada, boolean closed, Integer limite) {
        this.sigla = sigla;
        this.idAutostrada = idAutostrada;
        this.closed = closed;
        this.limite = limite;
